...
def mark_words(message):
    Избранные_слова = telebot.types.InlineKeyboardButton(text='Избранные слова', callback_data='1')
    Учить_свои_слова = telebot.types.InlineKeyboardButton(text='Учить свои слова',callback_data='2')
    Связь_с_нами = telebot.types.InlineKeyboardButton(text='Связь с вами',callback_data='3')
    Неизвестные_слова = telebot.types.InlineKeyboardButton(text='Неизвестные слова',callback_data='4')

    markup_inline=telebot.types.ReplyKeyboardMarkup()
    markup_inline.add(Избранные_слова)
    markup_inline.add(Учить_свои_слова)
    markup_inline.add(Связь_с_нами)
    markup_inline.add(Неизвестные_слова)
